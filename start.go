...
import (
	...
	_ "github.com/lib/pq"
	"github.com/mjfagundez/ent-test/ent"
	"github.com/mjfagundez/ent-test/ent/car"
	"github.com/mjfagundez/ent-test/ent/group"
	"github.com/mjfagundez/ent-test/ent/user"
)

func main() {
	client, err := ent.Open("postgres", "host=localhost port=5432 user=postgres dbname=cars password=9415")
	if err != nil {
